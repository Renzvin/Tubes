...
import com.tubespbp.Adapter.ReturnListAdapter;
...
public class ReturnBookFragment extends Fragment {
    ...
    private ReturnListAdapter borrowBukuAdapter;
    private RecyclerView.LayoutManager layoutManager;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v =  inflater.inflate(R.layout.returnlist_adapter, container, false);
        recyclerView = v.findViewById(R.id.return_recycler_view);
        return v;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        borrowBukuAdapter = new ReturnListAdapter(getContext(),ListBorrow);
