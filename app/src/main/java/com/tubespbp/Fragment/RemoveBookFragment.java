...
public class RemoveBookFragment extends Fragment {
    ...
    private DeleteBukuAdapter deleteBukuAdapter;
    private RecyclerView.LayoutManager layoutManager;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v =  inflater.inflate(R.layout.remove_adapter, container, false);

        recyclerView = v.findViewById(R.id.delete_recycler_view);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        deleteBukuAdapter = new DeleteBukuAdapter(getContext(),ListBuku);
        ...
        recyclerView.setAdapter(deleteBukuAdapter);
        setRecyclerView();
    }
    ...
    private void setRecyclerView(){
        ...
        bukuDAOCall.enqueue(new Callback<List<bukuDAO>>() {
            ...
            public void onResponse(Call<List<bukuDAO>> call, Response<List<bukuDAO>> response) {
                ...
                deleteBukuAdapter.notifyDataSetChanged();
