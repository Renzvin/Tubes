...
import com.tubespbp.Adapter.RemoveRequestAdapter;
...
public class RemoveRequestFragment extends Fragment {
    private List<requestDAO> ListRequest;
    private RecyclerView recyclerView;
    private RemoveRequestAdapter reqeustAdapter;
    private RecyclerView.LayoutManager layoutManager;

    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v =  inflater.inflate(R.layout.userremoverequest_adapter, container, false);
        recyclerView = v.findViewById(R.id.userremoverequest_recycler_view);
        return v;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        reqeustAdapter = new RemoveRequestAdapter(getContext(),ListRequest);
